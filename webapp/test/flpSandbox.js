		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vndrmgmtlistpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vndrmgmtlistpage-display": {
								"semanticObject": "vndrmgmtlistpage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vndrmgmt.listpage",
									"url": sap.ui.require.toUrl("vndrmgmt/listpage")
								}
							}
						}
					}
